...
class TestOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            "--split", type=str, default="test", help="train, val, test, etc"
        )
        ...
        parser.add_argument(
            "--save_dir",
            type=str,
            default="/content/Pix2Pix-VC/data_cache/results",
        ...
        parser.add_argument(
            ...
            default="stft",
            choices=["melgan", "stft"],
            help="Method used to converet between audio and spectrogtams.",
        )
