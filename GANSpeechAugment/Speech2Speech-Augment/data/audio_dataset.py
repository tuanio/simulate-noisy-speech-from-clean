...
class AudioDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        assert len(self.A_paths) == len(
            self.B_paths
        ), "Both domains should have same number of samples for aligned Dataset."
        ...
        self.clean_specs = Parallel(n_jobs=self.num_cores, prefer="threads")(
            delayed(processInput)(i, self.spec_power, self.phase, self.channels)
