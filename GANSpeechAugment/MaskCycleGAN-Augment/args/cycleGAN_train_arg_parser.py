...
class CycleGANTrainArgParser(TrainArgParser):
    ...
    def __init__(self):
        ...
        self.parser.add_argument(
            "--speaker_B_id",
            type=str,
            default="DCB_se2_ag3_m_02_1",
            help="Target speaker id (From CORAAL dataset).",
        )
        self.parser.add_argument(
            "--preprocessed_data_dir",
            type=str,
            default="vcc2018_training_preprocessed/",
        ...
        self.parser.add_argument(
            "--num_frames_validation",
            type=int,
            default=320,
            help="Num frames per validation sample.",
        )
        self.parser.add_argument(
            "--max_mask_len",
            type=int,
        ...
        self.parser.add_argument(
            ...
            type=bool,
            default=True,
            help="Use Differentiable Augmentation during training?",
        )
        self.parser.add_argument(
            "--patchNCELoss",
            type=bool,
            default=False,
            help="Use patchNCE Loss during training",
        )
